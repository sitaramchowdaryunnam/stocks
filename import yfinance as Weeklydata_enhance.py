...
if __name__ == "__main__":
    ...
    start_date = "2023-08-13"  # Replace with the desired start date
    # end_date = "2023-08-10"
    ...
    for stock_symbol in stock_symbols:
        ...
        try:
            filename = 'C:/Users/muniv/Desktop/Market/Nifty_All500_weekly/{}_Weekly.csv'.format(stock_symbol)
            existing_data = pd.read_csv(filename, parse_dates=['Date'])  # Specify the 'Date' column as a datetime column
            
            # Fetch data for the current date
            current_data = get_yahoo_finance_historical_data(stock_symbol, start_date, tomorrow_date)
            current_data['Date'] = current_data.index  # Create a 'Date' column
            
            combined_data = pd.concat([existing_data, current_data])

            # Save the combined data back to the CSV file
            save_data_to_csv(stock_symbol, combined_data, frequency='W')
