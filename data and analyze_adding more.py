...
def Loaddata():
    for stock in stock_symbols:
        try:
            data = pd.read_csv('C:/Users/muniv/Desktop/Market/Nifty_All500/{}.csv'.format(stock)) 
            data1 = pd.read_csv('C:/Users/muniv/Desktop/Market/Nifty_All500_weekly/{}_weekly.csv'.format(stock))  
            out_file_name1 = 'C:/Users/muniv/Desktop/Market/Nifty_All500/{}.csv'.format(stock)
            out_file_name2 = 'C:/Users/muniv/Desktop/Market/Nifty_All500_weekly/{}_weekly.csv'.format(stock)
            print(stock) 
            print("###################################################################################################")
...
if __name__ == "__main__":
   ...
   # stock_symbols = ['3MINDIA.NS',	'ABB.NS',	'ACC.NS',	'AIAENG.NS']
    ...
    # end_date = "2023-08-07"   # Replace with the desired end date
    end_date = date.today()
